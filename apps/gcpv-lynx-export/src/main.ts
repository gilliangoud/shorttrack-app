...
const syncLocation = process.env.PAT_FILE || '/Volumes/competitions/BCST_2023/meet.pat';
const eventFile = process.env.EVT_FILE || '/Volumes/competitions/BCST_2023/LYNX.EVT';
